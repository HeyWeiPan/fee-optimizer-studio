...
**Feature 2 — Token inspector (`/token/:mint`)**
...
**Feature 3 — Split simulator (`/token/:mint/simulate`)**
...
**Feature 4 — Comparable launches (embedded in Feature 2)**
...
**Feature 5 — Update-config tx flow (in flight)**
